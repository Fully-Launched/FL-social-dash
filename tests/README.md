...
| `flow.test.mjs 1\|2\|3` | The full flow for 30 posts, clicking the real built pages in a headless browser: bulk add → approve → client approves/films → editor finishes → owner approves → client approves → posted. Run 2 adds client rejections and change requests; run 3 adds owner revisions and an editor who clicks Finished before uploading. |
